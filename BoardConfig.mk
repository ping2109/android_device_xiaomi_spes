...
BOARD_MKBOOTIMG_ARGS += --partition_size $(BOARD_BOOTIMAGE_PARTITION_SIZE)
TARGET_KERNEL_ARCH := arm64
#TARGET_KERNEL_CLANG_COMPILE := true
TARGET_KERNEL_HEADER_ARCH := arm64
TARGET_KERNEL_HEADER := kernel/xiaomi/spes
...
BOARD_SUPER_PARTITION_SIZE := 6350725684
BOARD_QTI_DYNAMIC_PARTITIONS_PARTITION_LIST := product system system_ext vendor
ifeq ($(PRODUCT_VIRTUAL_AB_OTA),true)
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 3175362838 # ( BOARD_SUPER_PARTITION_SIZE / 2 - 4MB )
else
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 6350725680 # ( BOARD_SUPER_PARTITION_SIZE - 4MB )
endif
